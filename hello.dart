void main() {
  ...
  const mySecondName = 'Luis'; // si estrictamente que no se va a modificar la variable uso const
  ...
  print('Hola ${myName.toUpperCase()} ${mySecondName} ${myApellido.toLowerCase()}');
}
